...
def Model2(input_tensor=None, train=False, retrain = False, newData = None, newTestData = None, inference_retrain = None):
    ...
    if train:
        ...
        model.load_weights(os.path.join(script_dir, "Model2.h5"))
        ...
        model.save_weights('./Model2_retrained.h5')
        ...
        if inference_retrain is None:
          ...
          model.load_weights(os.path.join(script_dir, "Model2_retrained.h5"))
          print(bcolors.OKBLUE + 'Model2 retrained loaded' + bcolors.ENDC)
